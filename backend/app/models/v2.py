...
class ThinkingNode(Base):
    ...
    kind = Column(SQLEnum("idea", "question", "answer", "insight", "assumption", "decision", "risk", "next_step", "followup", name="thinking_node_kind"), nullable=False)
    status = Column(SQLEnum("open", "answered", "suggested", "confirmed", "needs_context", "resolved", name="thinking_node_status"), nullable=False, default="open")
